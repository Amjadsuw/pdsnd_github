...
def get_filters():
    ...
    while True:
      day = input("\n Are you looking for a particular day? If so, please enter the day : Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday or type 'all' if you do not have any preference.\n")
...
def time_stats(df):
    ...
    populaDay = df['day_of_week'].mode()[0]
    print('Most Common day:', populaDay)
